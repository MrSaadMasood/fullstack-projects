...
export default function Messages({data, selectedChatSetter , getChatData,  chatFriendImageSetter}){
    ...
    return (
        ...
        onClick={()=>{ selectedChatSetter("normal"); getChatData(data.friendData, "normal");
