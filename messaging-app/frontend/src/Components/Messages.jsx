...
export default function Messages({data, selectedChatSetter, type = 1 , getChatData}){
    ...
    return (
        ...
        onClick={()=>{ selectedChatSetter(data.friendData.fullName); getChatData(data.friendData)}}>
